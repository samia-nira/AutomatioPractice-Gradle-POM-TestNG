...
public class Signup {
    ...
    public void memberSignUp() throws Exception {
        ...
        rbGender.click();
        txtFirstName.sendKeys("Samia");
        txtLastName.sendKeys("Nira");
        txtPassword.sendKeys("AUTO@123456");
        ...
        Thread.sleep(2000);
//        txtFirstName2.sendKeys("Samia");
//        txtLastName2.sendKeys("Nira");
